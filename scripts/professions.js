...
export const PROFESSIONS = {
    "anthropologist": {
        ...
        requiredSkills: [
            ...
            { name: "Foreign Language (Spanish)", value: 50 },
            { name: "Foreign Language (Chinese)", value: 40 },
    ...
    "foreign_service": {
        ...
        requiredSkills: [
            ...
            { name: "Foreign Language (Arabic)", value: 50 },
            { name: "Foreign Language (French)", value: 50 },
            { name: "Foreign Language (Russian)", value: 40 },
    ...
    "intelligence_analyst": {
        ...
        requiredSkills: [
            ...
            { name: "Computer Science", value: 40 },
            { name: "Criminology", value: 40 },
            { name: "Foreign Language (Japanese)", value: 50 },
            { name: "Foreign Language (German)", value: 50 },
            { name: "Foreign Language (Korean)", value: 40 },
            { name: "History", value: 40 },
            { name: "HUMINT", value: 50 },
            { name: "SIGINT", value: 40 }
        ],
    ...
    "intelligence_case_officer": {
        ...
        requiredSkills: [
            ...
            { name: "Drive", value: 40 },
            { name: "Firearms", value: 40 },
            { name: "Foreign Language (Mandarin)", value: 50 },
            { name: "Foreign Language (Persian)", value: 40 },
            { name: "HUMINT", value: 60 },
